...
class StructuredFilenameTemplateTests(unittest.TestCase):
    ...
    def test_missing_raw_marker_preserves_season_zero(self):
        self.assertEqual(
            self.generate({
                "title": "First Things First",
                "season_number": 0,
    ...
    def test_structured_template_preserves_subdirectories(self):
        ...
        self.assertEqual(
            filename,
            "TV Shows/First Things First/Season 00/"
            "First Things First - S00E155.ts",
        )
